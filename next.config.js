...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspValue = "default-src 'self'; " +
      ...
      "font-src 'self' https://fonts.gstatic.com https://http2.mlstatic.com https://*.mlstatic.com; " +
      "img-src 'self' data: https: blob: https://http2.mlstatic.com https://*.mlstatic.com; " +
      "connect-src 'self' https://*.firebaseio.com https://*.googleapis.com https://api.mercadopago.com https://*.mercadopago.com https://sdk.mercadopago.com https://api.mercadolibre.com https://*.mercadolibre.com https://www.mercadolibre.com https://http2.mlstatic.com https://*.mlstatic.com; " +
      "frame-src 'self' https://www.mercadolibre.com https://*.mercadolibre.com https://vercel.live;";
